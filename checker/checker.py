...
# salesperson_name = "SURAJSINH PARMAR"
...
#     lambda x: x['final_amount'] * 0.8 if 
#     pd.notna(x['presalesperson_name']) and x['presalesperson_name'] != "" else x['final_amount'], 
#     axis=1
# )
